// // Windows compilation commands. Should work at least with MatlabR2014b.
...
// mex equations6x6_doubleIO_cpp.cpp polyroots_cpp.obj bairstow1_cpp.obj poly_division_cpp.obj GSolve.obj bubbleSort.obj equations6x6_B_cpp.obj equations6x6_C1_cpp.obj equations6x6_C2_cpp.obj equations6x6_C3_cpp.obj equations6x6_C4_cpp.obj equations6x6_C5_cpp.obj equations6x6_C6_cpp.obj -lmpfr
// // // 
...
// mex equations6x6_doubleIO_cpp.cpp polyroots_cpp.o bairstow1_cpp.o poly_division_cpp.o GSolve.o bubbleSort.o equations6x6_B_cpp.o equations6x6_C1_cpp.o equations6x6_C2_cpp.o equations6x6_C3_cpp.o equations6x6_C4_cpp.o equations6x6_C5_cpp.o equations6x6_C6_cpp.o -lmpfr
...
void mexFunction(int nlhs, mxArray *plhs[],int nrhs, const mxArray *prhs[]) /* Input variables */
{
    ...
    k56  = mxGetScalar(prhs[29]); //      printf("dB12 = %s\n",dB12.toString("%.60RNf").c_str());
    
    // max_iter
    max_iter = 100;
        
    // eps
    eps = 1E-20;//     printf("EPS = %s\n",eps.toString("%.60RNf").c_str());
    ...
    // Roots
    polyroots_cpp(C1,p_order,max_iter,eps,r1);
    polyroots_cpp(C2,p_order,max_iter,eps,r2);
    polyroots_cpp(C3,p_order,max_iter,eps,r3);
    polyroots_cpp(C4,p_order,max_iter,eps,r4);
    polyroots_cpp(C5,p_order,max_iter,eps,r5);
    polyroots_cpp(C6,p_order,max_iter,eps,r6);
    ...
    for(i1 = 0;i1 < 6;i1++){
        ...
        for(i=0; i<p_order; i++){
            cte1C[i] = "0.00000"; cte2C[i] = "0.00000"; cte3C[i] = "0.00000"; cte4C[i] = "0.00000";  cte5C[i] = "0.00000"; cte6C[i] = "0.00000";
    ...
    // Output
    const int n = p_order;
    mwSize ndims[] ={p_order};
    mwSize ndims6[] ={6*p_order};
    mwSize ndimsSq[] ={p_order*p_order} ;
